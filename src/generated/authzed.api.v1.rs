...
pub struct Relationship {
    ...
    pub optional_expires_at: ::core::option::Option<
...
pub struct RelationshipFilter {
    ...
    /// NOTE: It is not prefixed with "optional\_" for legacy compatibility.
    #[prost(string, tag = "1")]
...
pub struct WriteRelationshipsRequest {
    ...
    /// transaction.
    #[prost(message, optional, tag = "3")]
    pub optional_transaction_metadata: ::core::option::Option<
...
pub struct WatchResponse {
    ...
    pub full_revision_metadata: ::prost::alloc::vec::Vec<
        super::super::super::google::protobuf::Struct,
    >,
}
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
