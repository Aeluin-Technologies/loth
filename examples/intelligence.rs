...
async fn main() -> Result<(), AuthError> {
    ...
    let endpoint =
        env::var("SPICEDB_ENDPOINT").expect("SPICEDB_ENDPOINT environment variable is required");
    ...
    info!(
        ...
        "CASE 1: Valid ReBAC and ABAC context"
    );
    ...
    info!(
        ...
        "CASE 2: ReBAC matches, but ABAC filters deny access"
    );
    ...
    info!(
        ...
        "CASE 3: ABAC matches, but ReBAC relationship graph denies access"
    );
